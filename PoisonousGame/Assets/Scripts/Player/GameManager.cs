...
public class GameManager : MonoBehaviour
{
    public Int32 CalculateHealth(Player player)
    {
        ...
        Int32 result = (player.entity.resistence * 10) + 10;
    ...
    public Int32 CalculateMana(Player player)
    {
        ...
        Int32 result = (player.entity.intelligence * 10) + 5;
    ...
    {
        // Formula: (intelligence * 10) + (level * 4) + 5
        Int32 result = (player.entity.resistence + player.entity.forcaVontade) + 5;
    ...
    public Int32 CalculateDamage(Player player, int weaponDamage)
    {
        ...
        Int32 result = (player.entity.strength * 2) + (weaponDamage * 2) + rnd.Next(1, 20);
    ...
    public Int32 CalculateDefense(Player player, int armorDefense)
    {
        ...
        Int32 result = (player.entity.resistence * 2) + armorDefense;
